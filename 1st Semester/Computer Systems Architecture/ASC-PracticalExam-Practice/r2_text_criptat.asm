...
segment data use32 class=data
        ...
        desc_fisier dd 0
        buffer db 0
        ;TabCriptare_mica db "cdefghijklmnopqrstuvwxyzab"
        TabCriptare_mica db "xyzabcdefghijklmnopqrstuvw"
        ;TabCriptare_mare db "CDEFGHIJKLMNOPQRSTUVWXYZAB"
        TabCriptare_mare db "XYZABCDEFGHIJKLMNOPQRSTUVW"
